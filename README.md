...
- [x] Web UI prototype: upload, evidence-based result and pharmacy inventory view
...
The static web prototype is implemented; API-backed extraction and persistence remain to be connected.

## Run the web prototype

Open `index.html` in a browser, or serve the folder with any static file server. The prototype includes sample verification data so the result and inventory flows can be explored before the Django API is connected.
